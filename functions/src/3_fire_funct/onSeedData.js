import { docSellerReviewsBatch, docSellerProfileSet } from '2_fire_store'
	...
	try {
		if (context.auth.uid === 'twitch_238533965') {
			docSellerProfileSet(uid)({
				...
				[FIRESTORE_SELLER_SETTINGS_PROFILE_DISPLAY_NAME]: 'Mike Scheinder',
				[FIRESTORE_SELLER_SETTINGS_PROFILE_GENDER]: FIRESTORE_SELLER_SETTINGS_PROFILE_GENDER_FEMALE,
				[FIRESTORE_SELLER_SETTINGS_PROFILE_CHANNELS]: {
