...
const Cookie = () => {
	return (
		<>
			...
			<h4 className='paragraph-content text-capitalize'>What are cookies</h4>
			<p className='paragraph-content mb-5'>
			...
			<h4 className='paragraph-content text-capitalize'>How we use cookies</h4>
			<p className='paragraph-content mb-5'>
			...
			<h4 className='paragraph-content text-capitalize'>Disabling cookies</h4>
			<p className='paragraph-content mb-5'>
			...
			<h4 className='paragraph-content text-capitalize'>The cookies we set</h4>
			<ul>
				<li>
			...
			<h4 className='paragraph-content text-capitalize'>Third party Cookies</h4>
			<p className='paragraph-content mb-5'>
			...
			<ul>
				...
				<li>
					<p className='paragraph-content mb-5'>
						...
						social networks whose features you have integrated with your site?,
			...
			<p>
				<h4 className='paragraph-content text-capitalize'>More information</h4>
			</p>
			<p className='paragraph-content mb-5'>
