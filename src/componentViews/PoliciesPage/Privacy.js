	...
	return (
		<>
			...
			<p className='paragraph-content mb-5'>
				...
				required, this information may include your email address, name, credit
				card information, bank information, or other Personal Information. You
				can choose not to provide us with your Personal Information, but then
				you may not be able to take advantage of some of the Website's features.
				Users who are uncertain about what information is mandatory are welcome
				to contact us.
			</p>
			<h4 className='paragraph heading'>Managing personal information</h4>
			<p className='paragraph-content mb-5'>
			...
			<p className='paragraph-content mb-5'>
				...
				operate our Website and Services. Information collected automatically is
			...
			<h4 className='paragraph-content text-capitalize'>Privacy of children</h4>
			<p className='paragraph-content mb-5'>
			...
			<h4 className='paragraph-content text-capitalize'>Newsletters</h4>
			<p className='paragraph-content mb-5'>
			...
			<h4 className='paragraph-content text-capitalize'>Data breach</h4>
			<p className='paragraph-content mb-5'>
			...
			<h4 className='paragraph-content text-capitalize'>Legal disclosure</h4>
			<p className='paragraph-content mb-5'>
			...
			<p className='paragraph-content mb-5'>
				...
				Personal Data was collected. Policy was created with WebsitePolicies.
			</p>
			<h4 className='paragraph-content text-capitalize'>
			...
			<h4 className='paragraph-content text-capitalize'>Contacting us</h4>
			<p className='paragraph-content mb-5'>
				...
				<strong>admin@gamesenshi.com</strong>
			</p>
		</>
	)
}
