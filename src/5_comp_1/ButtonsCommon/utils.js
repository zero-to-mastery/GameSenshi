...
const options = [
	...
	{
		[BUTTONS_COMMON_ID]: FIRESTORE_SELLER_SETTINGS_PROFILE_CHANNELS_FACEBOOK,
		[BUTTONS_COMMON_ICON]: () => <i className='fab fa-facebook-f' />,
		[BUTTONS_COMMON_COLOR]: 'facebook',
	},
	{
		[BUTTONS_COMMON_ID]: FIRESTORE_SELLER_SETTINGS_PROFILE_CHANNELS_TWITCH,
		[BUTTONS_COMMON_ICON]: () => <i className='fab fa-twitch' />,
		[BUTTONS_COMMON_COLOR]: 'twitch',
	},
	{
		[BUTTONS_COMMON_ID]: FIRESTORE_SELLER_SETTINGS_PROFILE_CHANNELS_YOUTUBE,
...
const getVideoUrl = () => ({
	...
	[FIRESTORE_SELLER_SETTINGS_PROFILE_CHANNELS_TWITCH]: 'https://www.twitch.tv/',
	[FIRESTORE_SELLER_SETTINGS_PROFILE_CHANNELS_YOUTUBE]:
