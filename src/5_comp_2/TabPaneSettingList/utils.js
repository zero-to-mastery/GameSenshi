...
const settingListNotification = () => [
	{
		[SECTION]: FIRESTORE_USER_SETTINGS_NOTIFICATION_PUSH,
		[TITLE]: 'Push Notification',
		[CHECKBOXES]: [
			{
				[BODY]: 'Order Updates',
				[NAME]: FIRESTORE_USER_SETTINGS_NOTIFICATION_PUSH_ORDER_UPDATES,
			},
			{
				[BODY]: 'Chats',
				[NAME]: FIRESTORE_USER_SETTINGS_NOTIFICATION_PUSH_CHATS,
			},
			{
				[BODY]: 'Comments',
				[NAME]: FIRESTORE_USER_SETTINGS_NOTIFICATION_PUSH_COMMENTS,
			},
		],
	},
	{
		[SECTION]: FIRESTORE_USER_SETTINGS_NOTIFICATION_EMAIL,
		[TITLE]: 'Email Notification',
		[CHECKBOXES]: [
			{
				[BODY]: 'Order Updates',
				[NAME]: FIRESTORE_USER_SETTINGS_NOTIFICATION_EMAIL_ORDER_UPDATES,
			},
			{
				[BODY]: 'Newsletter',
				[NAME]: FIRESTORE_USER_SETTINGS_NOTIFICATION_EMAIL_NEWS_LETTER,
			},
			{
				[BODY]: 'Chats',
				[NAME]: FIRESTORE_USER_SETTINGS_NOTIFICATION_EMAIL_CHATS,
			},
			{
				[BODY]: 'Comments',
				[NAME]: FIRESTORE_USER_SETTINGS_NOTIFICATION_EMAIL_COMMENTS,
			},
		],
	},
]
