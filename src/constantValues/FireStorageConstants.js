...
const FIRESTORE_SENSHI_CHANNELS_FACEBOOK = 'facebook'
const FIRESTORE_SENSHI_CHANNELS_TWITCH = 'twitch'
const FIRESTORE_SENSHI_CHANNELS_YOUTUBE = 'youtube'

const FIRESTORE_SENSHI_GAMES_DOTA2 = 'Dota2'
const FIRESTORE_SENSHI_GAMES_PUBG = 'PUBG'
const FIRESTORE_SENSHI_GAMES_LOL = 'LOL'
const FIRESTORE_SENSHI_GAMES_APEX = 'Apex'
const FIRESTORE_SENSHI_GAMES_FORTNITE = 'Fortnite'

const FIRESTORE_SENSHI_MEDIA_AUDIO = 'audio'
const FIRESTORE_SENSHI_MEDIA_IMAGE = 'image'
const FIRESTORE_SENSHI_MEDIA_YOUTUBE = 'youtube'
