...
const FIRESTORE_USER_SENSHI_FAVOURITE = 'favourite'
...
const FIRESTORE_SENSHI_SETTINGS_PROFILE_ONLINE = 'online'
const FIRESTORE_SENSHI_SETTINGS_PROFILE_ONLINE_STATE = 'state'
const FIRESTORE_SENSHI_SETTINGS_PROFILE_ONLINE_UPDATED_AT = UPDATED_AT

const FIRESTORE_SENSHI_SETTINGS_PROFILE_AVATAR = STORAGE_SENSHI_AVATAR

const FIRESTORE_SENSHI_SETTINGS_PROFILE_GENDER = 'gender'
const FIRESTORE_SENSHI_SETTINGS_PROFILE_GENDER_FEMALE = 'female'

const FIRESTORE_SENSHI_SETTINGS_PROFILE_DISPLAY_NAME = 'displayName'

const FIRESTORE_SENSHI_SETTINGS_PROFILE_CHANNELS = 'channels'
const FIRESTORE_SENSHI_SETTINGS_PROFILE_CHANNELS_FACEBOOK = 'facebook'
const FIRESTORE_SENSHI_SETTINGS_PROFILE_CHANNELS_TWITCH = 'twitch'
const FIRESTORE_SENSHI_SETTINGS_PROFILE_CHANNELS_YOUTUBE = 'youtube'

const FIRESTORE_SENSHI_SETTINGS_PROFILE_GAMES_DOTA2 = 'Dota2'
const FIRESTORE_SENSHI_SETTINGS_PROFILE_GAMES_PUBG = 'PUBG'
const FIRESTORE_SENSHI_SETTINGS_PROFILE_GAMES_LOL = 'LOL'
const FIRESTORE_SENSHI_SETTINGS_PROFILE_GAMES_APEX = 'Apex'
const FIRESTORE_SENSHI_SETTINGS_PROFILE_GAMES_FORTNITE = 'Fortnite'

const FIRESTORE_SENSHI_SETTINGS_PROFILE_CAROUSEL = 'carousel'
const FIRESTORE_SENSHI_SETTINGS_PROFILE_CAROUSEL_IMAGE = 'image'
const FIRESTORE_SENSHI_SETTINGS_PROFILE_CAROUSEL_YOUTUBE = 'youtube'
