...
const options = [
	{
		[ICONS_COMMON_ID]: FIRESTORE_SENSHI_PROFILE_GAMES_DOTA2,
		[ICON_COMMON_PATH]: gameIconsPath('Dota2'),
		[ICONS_COMMON_TOOLTIP]: 'Dota 2',
	},
	{
		[ICONS_COMMON_ID]: FIRESTORE_SENSHI_PROFILE_GAMES_PUBG,
		[ICON_COMMON_PATH]: gameIconsPath('PUBG'),
		[ICONS_COMMON_TOOLTIP]: 'PUBG',
	},
	{
		[ICONS_COMMON_ID]: FIRESTORE_SENSHI_PROFILE_GAMES_LOL,
		[ICON_COMMON_PATH]: gameIconsPath('LOL'),
		[ICONS_COMMON_TOOLTIP]: 'LOL',
	},
	{
		[ICONS_COMMON_ID]: FIRESTORE_SENSHI_PROFILE_GAMES_APEX,
		[ICON_COMMON_PATH]: gameIconsPath('Apex'),
		[ICONS_COMMON_TOOLTIP]: 'Apex Legends',
	},
	{
		[ICONS_COMMON_ID]: FIRESTORE_SENSHI_PROFILE_GAMES_FORTNITE,
