...
const ROUTE_POLICY_PARAM_PRIVACY_POLICY = 'privacyPolicy'
const ROUTE_POLICY_PARAM_COOKIES = 'cookiesPolicy'
...
const ROUTE_PAGE_POLICY_PRIVACY_POLICY = `${ROUTE_PAGE_POLICY}/:${ROUTE_POLICY_PARAM_PRIVACY_POLICY}`
