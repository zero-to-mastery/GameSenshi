...
const ROUTE_PAGE_PROFILE_COMMON = `${ROUTE_PAGE_PROFILE}/:${ROUTE_PARAM_UID}`
...
const ROUTE_PARAM_TAB_PANE = 'tabPane'
...
const ROUTE_PAGE_SETTINGS_COMMON = `${ROUTE_PAGE_SETTINGS}/:${ROUTE_PARAM_TAB_PANE}(${ROUTE_SETTINGS_PARAM_GENERAL}|${ROUTE_SETTINGS_PARAM_PAYMENT}|${ROUTE_SETTINGS_PARAM_ACCOUNT}|${ROUTE_SETTINGS_PARAM_NOTIFICATION})`
...
const ROUTES = [
	...
	{
		[ROUTE_PATH]: ROUTE_PAGE_PROFILE_COMMON,
		[ROUTE_ACCESSIBILITY]: ROUTE_ACCESSIBILITY_FREE,
	},
	{
